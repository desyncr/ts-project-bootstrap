...
lender_autobid_save(autobid:any) {
...
lender_bank_accounts(){
}

lender_move_funds(move_funds:any) {
}

lender_transaction_list(filter:any) {
}

lender_transaction_cancel(operation_id:any) {
}

lender_transaction_advice_create(operation:any) {
}

lender_transaction_extract(operation:any) {
}

lender_loan_request_list(filter:any) {
}

lender_loan_request(id:any) {
}

lender_loan_request_detail(id:any) {
}

lender_loan_list(filter:any) {
}

lender_trade_elegible_loan_parts(filter:any) {
}

lender_trade_portfolio_list(filter:any) {
}

lender_trade_portfolio_own_list(filter:any) {
}

lender_trade_portfolio_loan_parts(id:any) {
}

lender_trade_portfolio_pre_calculate(portfolio:{}) {
}

lender_trade_portfolio_calculate(portfolio:{}) {
}

lender_trade_portfolio_create(portfolio:{}) {
}
